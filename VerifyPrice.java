...
public class VerifyPrice extends BaseTest {
	...
	public void highToLow() throws MalformedURLException {
		...
		if (driver.findElement(By.xpath("(//android.widget.TextView[@content-desc=\"test-Item title\"])[1]"))
				.isDisplayed()) {
			System.out.println("AssertText Title1 Success");
		} else if (driver.findElement(By.xpath("“//android.widget.TextView[@content-desc=\"test-Price\"])[1]”"))
				.isDisplayed()) {
		...
		// check high price3
		String price3 = driver.findElement(By.xpath("(//android.widget.TextView[@content-desc=\"test-Price\"])[3]"))
				.getText();
		System.out.println(price3);

		// check high price4
		String price4 = driver.findElement(By.xpath("(//android.widget.TextView[@content-desc=\"test-Price\"])[4]"))
				.getText();
	...
	public void lowToHigh() throws MalformedURLException {
		...
		// check low price1
		String element = driver.findElement(By.xpath("(//android.widget.TextView[@content-desc=\"test-Price\"])[1]"))
				.getText();
